...
class Groups extends CI_Controller
{
    ...
    public function read($id) 
    {
		...
		'title' => 'User Groups',
            ...
            $this->template->load('template','groups/groups_read', $data);
        } else {
    ...
    function pdf()
    {
        ...
        $html = $this->load->view('groups_pdf', $data, true);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2016-05-24 19:43:55 */
/* http://harviacode.com */