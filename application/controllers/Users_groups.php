...
class Users_groups extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template',users_groups/users_groups_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'group_id' => $row->group_id,
            ...
            $this->template->load('template',users_groups/users_groups_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template',users_groups/users_groups_form', $data);
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2016-05-24 19:42:42 */
/* http://harviacode.com */